...
SETTING_TAGS = [
    ...
    'abbey_monastery', 'church_cathedral', 'chapel', 'courtroom',
    'parliament', 'university', 'hospital', 'almshouse_workhouse',
    'guildhall_town_hall', 'museum_gallery',

    # Urban
    'city_street', 'square_plaza', 'alley', 'marketplace', 'shop',
    'tavern_inn', 'coffeehouse', 'theater', 'brothel', 'gambling_den',
    ...
    'garden_park', 'heath_moor', 'mountain', 'river_lake', 'seaside_beach',
    'orchard_vineyard', 'barn_stable', 'parsonage_vicarage', 'churchyard',
    'marsh_fen', 'cliff',
