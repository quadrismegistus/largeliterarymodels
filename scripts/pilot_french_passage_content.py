"""Pilot: PassageContentTask on 10K balanced French passages (gallica_literary_fictions).
...
Usage:
    python scripts/pilot_french_passage_content.py --model qwen3.5-35b-a3b --num-workers 3
    python scripts/pilot_french_passage_content.py --model sonnet --num-workers 4
"""
...
SAMPLE_CSV = '/Users/rj416/github/largeliterarymodels/data/french_passages_10k_balanced_sample.csv'
...
def main():
    ...
    audit_csv = f'/Users/rj416/github/largeliterarymodels/data/pilot_2026-04_french_passage_content_{slug}.csv'
    ...
    # Build prompts in sample order (already shuffled)
    pdf_lookup = {}
